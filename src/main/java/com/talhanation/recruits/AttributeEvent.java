...
public class AttributeEvent {
    ...
    public static void entityAttributeEvent(final EntityAttributeCreationEvent event) {
        ...
        event.put(ModEntityTypes.DEMON_RECRUIT.get(), DemonRecruitEntity.setAttributes().build());
        event.put(ModEntityTypes.DEMON_MAGE.get(), MageDemonEntity.setAttributes().build());
        event.put(ModEntityTypes.ELF_MAGE.get(), MageElfEntity.setAttributes().build());
        event.put(ModEntityTypes.HUMAN_MAGE.get(), MageHumanEntity.setAttributes().build());
        event.put(ModEntityTypes.ANIMAL_MAGE.get(), MageAnimalEntity.setAttributes().build());
