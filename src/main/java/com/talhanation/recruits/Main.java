...
public class Main {
    ...
    public static boolean isSpellbooksLoaded;
    ...
    private void setup(final FMLCommonSetupEvent event) {
        ...
        isSpellbooksLoaded = ModList.get().isLoaded("irons_spellbooks");//Iron's Spell 'n Spellbooks
    ...
    private void addCreativeTabs(BuildCreativeModeTabContentsEvent event) {
        if (event.getTabKey().equals(CreativeModeTabs.SPAWN_EGGS)) {
            ...
            event.accept(ModItems.DEMON_RECRUIT_SPAWN_EGG.get());
            event.accept(ModItems.DEMON_MAGE_SPAWN_EGG.get());
            event.accept(ModItems.HUMAN_MAGE_SPAWN_EGG.get());
            event.accept(ModItems.ELF_MAGE_SPAWN_EGG.get());
            event.accept(ModItems.ANIMAL_MAGE_SPAWN_EGG.get());
        }
