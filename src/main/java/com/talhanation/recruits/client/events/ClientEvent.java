...
public class ClientEvent {
    ...
    public static void entityRenderersEvent(EntityRenderersEvent.RegisterRenderers event){
        if(RecruitsClientConfig.RecruitsLookLikeVillagers.get()){
            ...
            EntityRenderers.register(ModEntityTypes.DEMON_RECRUIT.get(), RecruitVillagerRenderer::new );
            EntityRenderers.register(ModEntityTypes.DEMON_MAGE.get(), RecruitVillagerRenderer::new );
            ...
            EntityRenderers.register(ModEntityTypes.DEMON_RECRUIT.get(), RecruitHumanRenderer::new );
            EntityRenderers.register(ModEntityTypes.DEMON_MAGE.get(), RecruitHumanRenderer::new );
            EntityRenderers.register(ModEntityTypes.HUMAN_MAGE.get(), RecruitHumanRenderer::new );
            EntityRenderers.register(ModEntityTypes.ELF_MAGE.get(), RecruitHumanRenderer::new );
            EntityRenderers.register(ModEntityTypes.ANIMAL_MAGE.get(), RecruitHumanRenderer::new );
