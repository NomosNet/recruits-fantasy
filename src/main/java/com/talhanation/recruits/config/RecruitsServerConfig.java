...
public class RecruitsServerConfig {
    ...
    public static ForgeConfigSpec.IntValue MageCost;
    ...
    public static ForgeConfigSpec.ConfigValue<List<List<String>>> MageStartEquipments;
    ...
    public static ArrayList<List<String>> START_EQUIPMENT_MAGE = new ArrayList<>(
            List.of(Arrays.asList("minecraft:stick", "", "", "", "", "")
            ));
    ...
    static {
        ...
        MageCost = BUILDER.comment("""

                        The amount of currency required to hire a mage.
                        \t(takes effect after restart)
                        \tdefault: 12""")
                .worldRestart()
                .defineInRange("MageCost", 12, 0, 1453);
        ...
        MageStartEquipments = BUILDER.comment("""

                        Mage Start Equipments
                        Default: [["minecraft:stick", "", "", "", "", ""]]
                        """)
                .worldRestart()
                .define("MageStartEquipments", START_EQUIPMENT_MAGE);
