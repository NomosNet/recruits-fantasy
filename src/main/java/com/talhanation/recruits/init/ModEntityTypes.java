...
public class ModEntityTypes {
    ...
    public static final RegistryObject<EntityType<DemonRecruitEntity>> DEMON_RECRUIT = ENTITY_TYPES.register("demon_recruit",
            () -> EntityType.Builder.of(DemonRecruitEntity::new, MobCategory.CREATURE)
                    .sized(0.6F, 1.95F)
                    .clientTrackingRange(10)
                    .canSpawnFarFromPlayer()
                    .build(new ResourceLocation(Main.MOD_ID, "demon_recruit").toString()));

    public static final RegistryObject<EntityType<MageDemonEntity>> DEMON_MAGE = ENTITY_TYPES.register("demon_mage",
            () -> EntityType.Builder.of(MageDemonEntity::new, MobCategory.CREATURE)
                    .sized(0.6F, 1.95F)
                    .clientTrackingRange(10)
                    .canSpawnFarFromPlayer()
                    .build(new ResourceLocation(Main.MOD_ID, "demon_mage").toString()));

    public static final RegistryObject<EntityType<MageHumanEntity>> HUMAN_MAGE = ENTITY_TYPES.register("human_mage",
            () -> EntityType.Builder.of(MageHumanEntity::new, MobCategory.CREATURE)
                    .sized(0.6F, 1.95F)
                    .clientTrackingRange(10)
                    .canSpawnFarFromPlayer()
                    .build(new ResourceLocation(Main.MOD_ID, "human_mage").toString()));

    public static final RegistryObject<EntityType<MageElfEntity>> ELF_MAGE = ENTITY_TYPES.register("elf_mage",
            () -> EntityType.Builder.of(MageElfEntity::new, MobCategory.CREATURE)
                    .sized(0.6F, 1.95F)
                    .clientTrackingRange(10)
                    .canSpawnFarFromPlayer()
                    .build(new ResourceLocation(Main.MOD_ID, "elf_mage").toString()));

    public static final RegistryObject<EntityType<MageAnimalEntity>> ANIMAL_MAGE = ENTITY_TYPES.register("animal_mage",
            () -> EntityType.Builder.of(MageAnimalEntity::new, MobCategory.CREATURE)
                    .sized(0.6F, 1.95F)
                    .clientTrackingRange(10)
                    .canSpawnFarFromPlayer()
                    .build(new ResourceLocation(Main.MOD_ID, "animal_mage").toString()));
