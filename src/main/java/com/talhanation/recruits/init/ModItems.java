...
public class ModItems {
    ...
    public static final RegistryObject<SpawnEggItem> DEMON_RECRUIT_SPAWN_EGG = createSpawnEggItem("demon_recruit", ModEntityTypes.DEMON_RECRUIT::get, 16755200, 16777045);
    public static final RegistryObject<SpawnEggItem> DEMON_MAGE_SPAWN_EGG = createSpawnEggItem("demon_mage", ModEntityTypes.DEMON_MAGE::get, 16755200, 16777045);
    public static final RegistryObject<SpawnEggItem> HUMAN_MAGE_SPAWN_EGG = createSpawnEggItem("human_mage", ModEntityTypes.HUMAN_MAGE::get, 16755200, 16777045);
    public static final RegistryObject<SpawnEggItem> ELF_MAGE_SPAWN_EGG = createSpawnEggItem("elf_mage", ModEntityTypes.ELF_MAGE::get, 16755200, 16777045);
    public static final RegistryObject<SpawnEggItem> ANIMAL_MAGE_SPAWN_EGG = createSpawnEggItem("animal_mage", ModEntityTypes.ANIMAL_MAGE::get, 16755200, 16777045);
