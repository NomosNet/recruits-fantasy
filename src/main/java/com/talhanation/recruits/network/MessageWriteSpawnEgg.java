...
public class MessageWriteSpawnEgg implements Message<MessageWriteSpawnEgg> {
    ...
    public void executeServerSide(NetworkEvent.Context context) {
        ...
        player.getCommandSenderWorld().getEntitiesOfClass(
            ...
            } else if (type.getDescriptionId().equals("entity.recruits.demon_recruit")) {
                itemStack = new ItemStack(ModItems.DEMON_RECRUIT_SPAWN_EGG.get());
            } else if (type.getDescriptionId().equals("entity.recruits.demon_mage")) {
                itemStack = new ItemStack(ModItems.DEMON_MAGE_SPAWN_EGG.get());
            } else if (type.getDescriptionId().equals("entity.recruits.elf_mage")) {
                itemStack = new ItemStack(ModItems.ELF_MAGE_SPAWN_EGG.get());
            } else if (type.getDescriptionId().equals("entity.recruits.animal_mage")) {
                itemStack = new ItemStack(ModItems.ANIMAL_MAGE_SPAWN_EGG.get());
            } else if (type.getDescriptionId().equals("entity.recruits.human_mage")) {
                itemStack = new ItemStack(ModItems.HUMAN_MAGE_SPAWN_EGG.get());
            }
